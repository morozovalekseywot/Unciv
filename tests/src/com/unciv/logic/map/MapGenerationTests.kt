...
class MapGenerationTests {
    ...
    fun terrainTileCountsReasonableForHexMaps() {
        ...
        assertApproximately( terrainCounts["Desert"], 830)
        ...
        assertApproximately(featureCounts["Ice"], 32)
    ...
    fun terrainTileCountsReasonableForRectangleMaps() {
        ...
        assertApproximately( terrainCounts["Desert"], 1192)
        ...
        assertApproximately(featureCounts["Ice"], 180)
        ...
        assertApproximately( featureCounts["Oasis"], 40)
    ...
    fun terrainTileCountsReasonableForFlatEarthMaps() {
        ...
        assertApproximately( terrainCounts["Desert"], 1080)
        ...
        assertApproximately(featureCounts["Ice"], 1000)
        ...
        assertApproximately( featureCounts["Flood plains"], 55)
